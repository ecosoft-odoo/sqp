        ...
        for pick in self.browse(cr, uid, ids, context=context):
                ...
                move_obj.write(cr, uid, [move.id],
                        {
                            ...
                            'product_uos_qty': (move.product_qty - partial_qty[move.id]) * (product.uos_id and product.uos_coeff or 1), #TODO: put correct uos_qty
                            # end kittiu                            'prodlot_id': False,
                            'tracking_id': False,
                        })
            ...
            for move in too_many:
                ...
                defaults = {
                    ...
                    #'product_uos_qty': product_qty, #TODO: put correct uos_qty
                    'product_uos_qty': product_qty * (product.uos_id and product.uos_coeff or 1), #TODO: put correct uos_qty
                    # end kittiu                    'product_uom': product_uoms[move.id]
                }
