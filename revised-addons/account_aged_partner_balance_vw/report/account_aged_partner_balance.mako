                    ...
                    <td>
                        <table style="width: 100%; text-align:center;">
                            <tr>
                                ...
                                <th class="celdaTituloTabla" style="text-align:center;" width="10%">${_('Salesperson')}</th>
                            ...
                            <tr>
                                ...
                                <th class="celdaBoxUp" style="text-align:center;" width="10%">${obj.salesperson_id.name or ''|entity}</th>
