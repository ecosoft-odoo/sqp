...
class report_xml(osv.osv):
    ...
    _columns = {
        'attachment': fields.char('Save as Attachment Prefix', size=512, help='This is the filename of the attachment used to store the printing result. Keep empty to not save the printed reports. You can use a python expression with the object and time variables.'),
