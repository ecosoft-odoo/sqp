...
class purchase_landing_cost_position(osv.osv):
    ...
    _columns = {
        ...
        'amount': fields.float('Amount', required=True, digits_compute=dp.get_precision('Purchase Price'), help="""Landing cost for stock valuation. It will be added to the price of the supplier price."""),
        ...
        #'currency_amount': fields.float('Amount Currency', help="The amount expressed in an optional other currency."),
...
purchase_landing_cost_position()
