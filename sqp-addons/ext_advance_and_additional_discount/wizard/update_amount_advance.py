...
class update_amount_advance(osv.osv_memory):
    ...
    def default_get(self, cr, uid, fields, context=None):
        ...
        res.update({
            "amount_advance": invoice.amount_advance,
            "tax_line": [
                (0, 0, {
                    "tax_id": tax.id,
                    "base": tax.base,
    ...
    def update_amount_advance(self, cr, uid, ids, context=None):
        ...
        # Advance Amt
        amount_advance = wizards[0].amount_advance
        # Before Taxes
        ...
        cr.execute("""
            ...
            set amount_advance = %s, amount_beforetax = %s, amount_tax = %s,
                amount_beforeretention = %s, amount_total = %s
            where id = %s
        """, (amount_advance, amount_beforetax, amount_tax,
...
class update_account_invoice_tax(osv.osv_memory):
    _name = "update.account.invoice.tax"
    ...
    _columns = {
        ...
        "update_advance_id": fields.many2one(
            "update.amount.advance",
        )
    }
