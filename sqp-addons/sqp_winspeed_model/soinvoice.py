...
select ail.id, ai.date_invoice as date,
    ...
    rp.name as CustName,
    so.name as SONo,
    so.client_order_ref as CustPONo,
    null as CreditStartDate,
    aptl.days as CreditDays,
    to_char(ai.date_due, 'dd/mm/yyyy') as CreditEndDate,
    null as DueDate,
    null as SendDate,
    null as TranspCode,
    ...
    round((ail.quantity * ail.price_unit) - ail.price_subtotal, 2) as GoodDiscAmnt,
    ...
    ai.amount_untaxed as Sumgoodamnt,
    ...
    '1' as No,
    ai.amount_retention as Desciption,
    null as AdvnNo,
    -- null as InvNo,
    null as AdvnDate,
    ...
    to_char(ai.date_invoice, 'dd/mm/yyyy') as InvoiceDate,
